...
public final class FragmentReviewsBinding implements ViewBinding {
  ...
  private FragmentReviewsBinding(@NonNull ConstraintLayout rootView, @NonNull ListView list) {
  ...
  public static FragmentReviewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentReviewsBinding((ConstraintLayout) rootView, list);
    }
